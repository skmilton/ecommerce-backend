...
public class ProductServiceImpl implements ProductService {
    ...
    public void updateProduct(ProductDtoRequest productDtoRequest, String id){
        ...
        product.setCode(productDtoRequest.getCode());
        product.setQty(productDtoRequest.getQty());
        product.setDescription(productDtoRequest.getDescription());
        product.setUnitPrice(productDtoRequest.getUnitPrice());
        product.setUnitInStock(productDtoRequest.getUnitInStock());
        product.setImageUrl(productDtoRequest.getImageUrl());
        product.setCategory(productDtoRequest.getCategory());
